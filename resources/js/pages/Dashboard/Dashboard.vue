...
const dashboardData = ref<DashboardData>({
    ...
    scheduledAppointments: [], // Ensure this is always an array
});
...
onMounted(async () => {
    try {
        ...
        // Ensure scheduledAppointments is an array
        dashboardData.value = {
            ...response.data,
...
const sortedAppointments = computed(() => {
    // Ensure scheduledAppointments is an array before spreading
        ...
        <AppLayout>
            ...
            <div class="flex justify-between items-center mb-6">
                ...
                <div class="flex items-center gap-4">
                    <Link v-if="canAddPatients" href="/register"
                        ...
                        <table class="w-full">
                            <thead>
                                <tr class="bg-green-800 text-white">
                                    <th @click="sortAppointments('dentist_name')" 
                            ...
                            <tbody>
                                <tr v-for="appointment in sortedAppointments" :key="appointment.patient_name"
                                    ...
                                    <td class="px-4 py-3 text-sm text-gray-900" v-if="userType === 'Patient'">{{ appointment.dentist_name }}</td>
                                    <td class="px-4 py-3 text-sm text-gray-900" v-else>{{ appointment.patient_name }}</td>
