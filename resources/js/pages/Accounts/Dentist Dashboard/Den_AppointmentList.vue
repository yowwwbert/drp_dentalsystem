...
const statusOptions = ['All Status', 'Scheduled', 'In Progress', 'Completed', 'Cancelled'];
...
function openTreatmentModal(appt: Appointment, idx: number) {
  editAppointment.value = JSON.parse(JSON.stringify(appt));
  editIndex.value = idx;
...
<template>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-4 rounded-xl p-4">
                            ...
                            <tr v-for="(appointment, idx) in paginatedAppointments" :key="appointment.id" class="border-b last:border-b-0 hover:bg-gray-50">
                                ...
                                <td class="py-3 px-4">
                                    <div class="relative">
                                        ...
                                        >
                                            <div class="p-2">
                                                <div
                                                    v-for="service in ['General Checkup', 'Dental Cleaning', 'Cavity Filling', 'Root Canal', 'Tooth Extraction', 'Crown', 'Whitening']"
                                                    :key="service"
                                ...
                                <td class="py-3 px-4">
                                    <div class="flex gap-2">
                                        ...
                                        >Edit</button>
                                        <button
                                            @click="openTreatmentModal(appointment, idx)"
            ...
            <div v-if="showTreatmentModal" class="absolute inset-0 flex items-center justify-center z-50">
                <div class="bg-white rounded-lg shadow-xl p-6 w-full max-w-2xl mx-4">
                    <div class="flex justify-between items-center mb-4">
                        <h2 class="text-xl font-bold text-gray-900">Treatment Plan</h2>
                        <button
                    ...
                    <div v-if="editAppointment" class="space-y-4">
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input
                                    type="text"
                                    :value="formatDate(editAppointment.date)"
                                    readonly
                                    class="w-full border border-gray-300 rounded px-3 py-2 bg-gray-50"
                                />
                            </div>
                        ...
                        <div>
                            ...
                            <textarea
                                v-model="editAppointment.treatmentPlan"
                                rows="4"
                                class="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-darkGreen-900"
                        ...
                        <div>
                            ...
                            <input
                                v-model="editAppointment.followUpDate"
                                type="date"
                                class="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-darkGreen-900"
                            />
                        </div>
