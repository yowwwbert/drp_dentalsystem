  ...
  return {
    ...
    Owner: [
      ...
      { name: 'Billing', path: `${basePath}/billing/Billing`, icon: FileText },
      {
        ...
        icon: Hospital,
        children: [
          { name: 'Dentists', path: `${basePath}/records/DentistRecords`, icon: UserCircle },
          { name: 'Staff', path: `${basePath}/records/ReceptionistRecords`, icon: UserCog },
          { name: 'Branches', path: `${basePath}/clinic/BranchSettings`, icon: MapPin },
          { name: 'Services', path: `${basePath}/clinic/ServicesList`, icon: ListOrdered },
        ],
      },
      { name: 'Data', path: `${basePath}/data/AppointmentData`, icon: ChartBar },
